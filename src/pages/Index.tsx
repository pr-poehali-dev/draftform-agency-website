...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white font-bold text-lg px-8 flex items-center gap-2" onClick={() => setShowInvestments(true)}>
      ...
      <Dialog open={showInvestments} onOpenChange={setShowInvestments}>
